(function(){
  ...
  const K={timeline:'rosterbot-timeline-v1',leave:'rosterbot-diary-annual-leave-v1',weekLeave:'rosterbot-week-leave-v1',weeks:'rosterbot-week-overrides-v1',days:'rosterbot-day-overrides-v1',locks:'rosterbot-week-locks-v1',checks:'rosterbot-pay-checks-v1',schema:'rosterbot-db-schema-v1',cleared:'rosterbot-cleared-v1'};
  const PERSONAL_KEYS=[K.timeline,K.leave,K.weekLeave,K.weeks,K.days,K.locks,K.checks,'rosterbot-session-settings-v1','rosterbot-shared-settings-v1','rosterbot-theme-v1.9','rosterbot-view-mode-v1','paybot-editor-view-v1','paybot-auto-next-v1','paybot-v06-state','rosterbot-last-backup-v1','rosterbot-first-use-v1','rosterbot-experience-v1','rosterbot-fortnight-allowances-v1','rosterbot-fortnight-notes-v1',K.schema];
  ...
  function resetTimelineForm(date=''){
    ...
    const chosenDate=date||todayIso(),hit=positionAt(chosenDate),s=settings(),primary=hit&&!hit.timelineMissing?hit:null;
  ...
  function beginEdit(id){
    const a=timeline().find(x=>x.id===id);if(!a)return;editingArrangementId=id;editorContext='edit';builderDirty=false;
